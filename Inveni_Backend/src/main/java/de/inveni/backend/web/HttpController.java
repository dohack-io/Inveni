...
public class HttpController {
    ...
    public PropertyReturnDTO addPossibleOwner(@RequestBody UserPropertyDTO pair){
        ...
        if(Objects.nonNull(user) && Objects.nonNull(property)){
            ...
            return new PropertyReturnDTO(propertyRepository.save(property));
        }
        return null;
    }
    ...
    public UserReturnDTO addPossibleProperty(@RequestBody UserPropertyDTO pair){
        User user = userRepository.getById(pair.getUserID());
        Property property = propertyRepository.getById(pair.getPropertyID());
        if(Objects.nonNull(user) && Objects.nonNull(property)){
            user.addProperty(property);
            return new UserReturnDTO(userRepository.save(user));
        }
        return null;
    }
